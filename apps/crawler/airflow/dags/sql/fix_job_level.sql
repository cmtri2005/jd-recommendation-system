-- Fix Job Level for existing records in unified_jobs table
...
SET job_level = CASE
    ...
    -- 3. Lead (Check before Senior/Junior to catch 'Team Lead')
...
-- Verify results
-- SELECT job_level, COUNT(*) FROM unified_jobs GROUP BY job_level;
